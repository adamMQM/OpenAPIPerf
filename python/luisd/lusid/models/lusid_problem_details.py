...
class LusidProblemDetails(BaseModel):
    """
    A description of a problem that has arisen during the processing of a request.  # noqa: E501
    """
    name: constr(strict=True, min_length=1) = Field(..., description="The name of the error")
    error_details: Optional[conlist(Dict[str, StrictStr])] = Field(None, alias="errorDetails", description="Any additional informational information available about the nature and detail of the problem")
    code: StrictInt = Field(..., description="Get the error code of the response")
