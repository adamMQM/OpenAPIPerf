...
class ResourceListOfAddressKeyDefinition(BaseModel):
    """
    A collection of resources that can be returned from requests.  # noqa: E501
    """
    values: conlist(AddressKeyDefinition) = Field(..., description="The resources to list.")
    ...
    def from_dict(cls, obj: dict) -> ResourceListOfAddressKeyDefinition:
        ...
        if not isinstance(obj, dict):
            return ResourceListOfAddressKeyDefinition.parse_obj(obj)

        _obj = ResourceListOfAddressKeyDefinition.parse_obj({
