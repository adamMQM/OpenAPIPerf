...
class PagedResourceListOfVirtualRow(BaseModel):
    ...
    values: conlist(VirtualRow) = Field(..., description="The resources to list.")
    ...
    def from_dict(cls, obj: dict) -> PagedResourceListOfVirtualRow:
        ...
        if not isinstance(obj, dict):
            return PagedResourceListOfVirtualRow.parse_obj(obj)

        _obj = PagedResourceListOfVirtualRow.parse_obj({
