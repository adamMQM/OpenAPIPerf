...
class AccessControlledAction(BaseModel):
    """
    An action that can be access controlled  # noqa: E501
    """
    description: constr(strict=True, min_length=1) = Field(..., description="The description of the action")
    action: ActionId = Field(...)
    limited_set: Optional[conlist(IdSelectorDefinition)] = Field(None, alias="limitedSet", description="When populated, the provided values are the limited set of resources that are allowed to be specified for  access control for this action")
