...
class AnnulSingleStructuredDataResponse(BaseModel):
    ...
    value: Optional[datetime] = Field(None, description="The time at which the identifier was annulled")
    ...
    def from_dict(cls, obj: dict) -> AnnulSingleStructuredDataResponse:
        ...
        if not isinstance(obj, dict):
            return AnnulSingleStructuredDataResponse.parse_obj(obj)

        _obj = AnnulSingleStructuredDataResponse.parse_obj({
            "href": obj.get("href"),
            "value": obj.get("value"),
