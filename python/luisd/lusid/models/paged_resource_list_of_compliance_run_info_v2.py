...
class PagedResourceListOfComplianceRunInfoV2(BaseModel):
    ...
    values: conlist(ComplianceRunInfoV2) = Field(..., description="The resources to list.")
    ...
    def from_dict(cls, obj: dict) -> PagedResourceListOfComplianceRunInfoV2:
        ...
        if not isinstance(obj, dict):
            return PagedResourceListOfComplianceRunInfoV2.parse_obj(obj)

        _obj = PagedResourceListOfComplianceRunInfoV2.parse_obj({
