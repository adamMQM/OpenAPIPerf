...
class AccessControlledResource(BaseModel):
    """
    A resource to which access can be controlled  # noqa: E501
    """
    application: Optional[StrictStr] = Field(None, description="The application to which this resource belongs")
    name: Optional[StrictStr] = Field(None, description="The display name of the resource")
    description: constr(strict=True, min_length=1) = Field(..., description="The description of the resource")
    actions: conlist(AccessControlledAction) = Field(..., description="The actions acceptable for this type of resource")
    identifier_parts: Optional[conlist(IdentifierPartSchema)] = Field(None, alias="identifierParts", description="The constituent parts of a valid identifier for this resource")
