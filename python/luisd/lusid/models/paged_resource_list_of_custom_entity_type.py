...
class PagedResourceListOfCustomEntityType(BaseModel):
    ...
    values: conlist(CustomEntityType) = Field(..., description="The resources to list.")
    ...
    def from_dict(cls, obj: dict) -> PagedResourceListOfCustomEntityType:
        ...
        if not isinstance(obj, dict):
            return PagedResourceListOfCustomEntityType.parse_obj(obj)

        _obj = PagedResourceListOfCustomEntityType.parse_obj({
