...
class PagedResourceListOfComplianceRuleResponse(BaseModel):
    ...
    values: conlist(ComplianceRuleResponse) = Field(..., description="The resources to list.")
    ...
    def from_dict(cls, obj: dict) -> PagedResourceListOfComplianceRuleResponse:
        ...
        if not isinstance(obj, dict):
            return PagedResourceListOfComplianceRuleResponse.parse_obj(obj)

        _obj = PagedResourceListOfComplianceRuleResponse.parse_obj({
